...
def create_issue_from_scan(repository_url: str, bug_id: str, title: str, description: str):
    if g is None:
        raise RuntimeError('GITHUB_TOKEN is not set. Cannot create GitHub issues without a token.')
